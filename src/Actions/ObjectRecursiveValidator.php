...
use SigmaNet\SDK\Model\Types\AbstractCustomType;
use SigmaNet\SDK\Exception\Validation\BadGetterException;
...
use SigmaNet\SDK\Exception\Validation\InvalidPropertyTypeException;
use SigmaNet\SDK\Model\Interfaces\DataContainerInterface;
use SigmaNet\SDK\Model\Interfaces\RestorableInterface;
use SigmaNet\SDK\Utils\AccessorUtil;
...
class ObjectRecursiveValidator
{
     ...
     */
    public static function validate(DataContainerInterface $object): void
    {
        $existedFields = [];
